                  ...
                  {donationTypes.map((type) => (
                    <label key={type.id} className="cursor-pointer">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`p-4 rounded-lg border-2 transition-colors duration-200 ${donationType === type.id
                ...
                <div className="grid grid-cols-3 md:grid-cols-5 gap-3 mb-4">
                  {quickAmounts.map((quickAmount) => (
                    <button
                      ...
                      className={`p-3 rounded-lg border-2 font-semibold transition-colors duration-200 ${amount === quickAmount.toString()
