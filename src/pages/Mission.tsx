...
import { Users, TrendingUp, Send, BookOpen, UserPlus, HandHelping, DoorOpen , Heart} from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div key={index} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${isReversed ? 'lg:grid-flow-col-dense' : ''}`}>
              ...
              <div className={isReversed ? 'lg:col-start-1' : ''}>
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-navy">{section.title}<small><i> - {section.inBracket}</i></small></h2>
                </div>
      ...
      <div className="mt-20 bg-beige rounded-lg p-8 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-cream p-6 rounded-lg shadow-md">
            <HandHelping className="h-10 w-10 text-navy mb-4" />
          ...
          <div className="bg-cream p-6 rounded-lg shadow-md">
            <DoorOpen className="h-10 w-10 text-navy mb-4" />
            <h3 className="text-xl font-semibold text-navy mb-3">Open Homes</h3>
            <p className="text-charcoal-gray">
      ...
      <div className="mt-16 text-center bg-navy text-cream rounded-lg p-8 md:p-12">
        ...
        <p className="text-lg text-gray-300 mb-8">
          Whether through worship, serving, or giving, there are countless ways to be part
          of what God is doing through Windsor Gospel Assembly. Discover your place in the mission!
        </p>
        {/*<a*/}
        {/*  href="mailto:info@wgachurch.com"*/}
